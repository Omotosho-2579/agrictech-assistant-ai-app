...
cnn_model = tf.keras.models.load_model('plant_disease_model_mobilenetv2.h5')  # MobileNetV2 for disease detection
rf_model = joblib.load('yield_model.pkl')  # Random Forest for yield prediction

# Actual crop labels used in the yield model
crop_labels = [
...
with tabs[1]:
    ...
    with st.form("yield_form"):
        ...
        if submitted:
            ...
            st.markdown(download_report(input_data), unsafe_allow_html=True)
